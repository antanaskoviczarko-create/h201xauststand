...
// Bump PHOTO_VERSION when instructor images are replaced to force
// browsers and static hosts to fetch a fresh copy.
const PHOTO_VERSION = "2026-07-20-static";
const withVersion = (url: string) => `${url}?v=${PHOTO_VERSION}`;
const INSTRUCTOR_PHOTOS = {
  nikola: withVersion("/instructors/nikola-budanovic.webp"),
  aleksandar: withVersion("/instructors/aleksandar-mastilovic.webp"),
  ivan: withVersion("/instructors/ivan-barac.webp"),
  nenad: withVersion("/instructors/nenad-nikolovski.webp"),
};
...
const INSTRUCTORS = [
  ...
  },
  {
    ...
    bio: "Aleksandar Mastilović is an internationally recognized expert and consultant in digital transformation, telecommunications, applied artificial intelligence, cybersecurity, and smart cities, with more than two decades of cross-sectoral experience and over one hundred delivered projects across Serbia, Bosnia and Herzegovina, the United States, Israel, and other markets in the digital technology sphere. An EU Marie Curie Fellow with a strong academic and research background — former visiting researcher at Rutgers University, the University of Sydney, and La Trobe University — he served as Director of Telecommunications at the Communications Regulatory Agency of Bosnia and Herzegovina, where he led the introduction of 4G and architected the Western Balkans Roaming-Like-At-Home framework. He is an elected IEEE Board Member, UNOPS National Coordinator for Bosnia and Herzegovina, and ITU Certified Expert on National Cybersecurity Strategy Design. He is the author of the National Cybersecurity Strategy of Bosnia and Herzegovina, developed under the United Nations Development Program (UNDP), and of the Cybersecurity Maturity Assessment Methodology for MSMEs — a hybrid framework integrating Serbia's Information Security Act, the EU NIS2 Directive, the US NIST Framework, and ENISA SME guidelines, currently deployed across one hundred enterprises in Serbia. Within the NIS2 Officer training, Aleksandar contributes to the DAY 1 regulatory, institutional, and organizational context of digital security, with a particular focus on the European NIS2 Directive, change management, and the practical challenges of aligning organizations with new digital resilience requirements.",
  },
  {
    name: "Ivan Barać",
    initials: "IB",
